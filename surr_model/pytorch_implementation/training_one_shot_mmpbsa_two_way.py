...
from dataset import load_dataset_two_way_mmpbsa
...
def train():
    ...
    train_loader, val_loader = load_dataset_two_way_mmpbsa()
    ...
    for epoch in range(EPOCHS):
        ...
        if avg_vloss < best_vloss:
            ...
            torch.save(
                model.state_dict(),
                f"/home/kunzj/BindCraft_uva_internship/surr_model/pytorch_implementation/models/one_shot_mmpsa_two_way/{model_path}.pt",
            )
    ...
    with open("/home/kunzj/BindCraft_uva_internship/surr_model/pytorch_implementation/models/one_shot_mmpsa_two_way/model_performance.pkl", "wb") as f:
        pickle.dump(aux, f)
