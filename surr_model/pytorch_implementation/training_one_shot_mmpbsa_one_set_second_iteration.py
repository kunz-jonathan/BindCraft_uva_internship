...
from dataset import load_dataset_second_iteraion
...
def train():
    ...
    train_loader = load_dataset_second_iteraion()
    ...
    for epoch in range(EPOCHS):
        ...
        torch.save(
            model.state_dict(),
            f"/home/kunzj/BindCraft_uva_internship/surr_model/pytorch_implementation/models/second_iteration_training/{model_path}.pt",
        )

    with open("/home/kunzj/BindCraft_uva_internship/surr_model/pytorch_implementation/models/second_iteration_training/model_performance.pkl", "wb") as f:
        pickle.dump(aux, f)
