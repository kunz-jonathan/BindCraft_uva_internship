...
from dataset import load_datasets, load_datasets_our_data
...
def train():
    ...
    for epoch in range(EPOCHS):
        ...
        if avg_vloss < best_vloss:
            ...
            torch.save(
                model.state_dict(),
                f"/home/kunzj/BindCraft_uva_internship/surr_model/pytorch_implementation/models/one_shot_mmpsa/{model_path}.pt",
            )
    ...
    with open("/home/kunzj/BindCraft_uva_internship/surr_model/pytorch_implementation/models/one_shot_mmpsa/model_performance.pkl", "wb") as f:
        pickle.dump(aux, f)
